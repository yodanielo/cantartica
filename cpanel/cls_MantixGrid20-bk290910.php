...
class MantixGrid {
    ...
    function ver() {
        ...
        if(!$_POST["tipo"]) {
            ...
            //variables para ctt
            $r.='<input type="hidden" name="idpre" value="'.$_POST["idpre"].'" />';
            $r.='<input type="hidden" name="manda" value="'.$_POST["manda"].'" />';
        ...
        if (!$this->datos->vacio() ) {
            if(!$_POST["tipo"]) {
                ...
                if ($this->atributos["ver_barra"]=="") {
                    ...
                    if($this->atributos["ver_ordenar"]=="1") {
		...
		for ($a=1;$a<=$this->contador_esp;$a++)
		{
            ...
            if(!$_POST["tipo"]) {
                ...
                if ($t_pag>1 ) {
                    ...
                    $r.="".$patras.'P&aacute;gina: <input type="text" value="'.$p_actual.'" id="irpag" /> de '.$t_pag;
                    if ($p_actual <$t_pag ) {
                ...
                for ($a=1;$a<=$t_pag;$a++) {
                    ...
                    $r.='&nbsp;Mostrando del '.$regdesde." al ".$reghasta." de ".$this->datos->l_nroreg;
                }
                $r.="</td></tr>";

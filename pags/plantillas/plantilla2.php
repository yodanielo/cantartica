    ...
    if(count($plantillas)>0) {
        foreach($plantillas as $p) {
            ...
            switch($ext) {
                ...
                case 'gif':
                case 'png':
                    echo '<div class="pl2rec"><img src="tumber.php?w=362&src=images/recursos/'.$p->recurso1.'"/><div class="subtitlei">'.cie($p->recurso2).'</div></div>';
                    break;
                case 'flv':
                    echo '<div class="pl2rec"><script type="text/javascript">runSWF2("http://www.seriesid.com/player/player.swf?skin=http://www.seriesid.com/player/beelden.zip&file='.$config_live_site.'/images/recursos/'.$p->recurso1.'",362,241,"10.0.0","transparent")</script><div class="subtitlei">'.cie($p->recurso2).'</div></div>';
                    break;
            }
        }
    }
...
<div id="col2_a" class="texto_<?=str_replace("-","_",$_GET["opc"])?>">
